...
@Policy.PolicySpec(name = "prefix.item-based.SegmentedLRU")
public final class PISegmentedLruPolicy implements Policy {
  ...
  public PISegmentedLruPolicy(Config config) {
