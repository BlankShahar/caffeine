...
@Policy.PolicySpec(name = "prefix.source-based.HillClimberWindowTinyLFU")
public class PSHillClimberWindowTinyLfuPolicy implements Policy {
  ...
  public PSHillClimberWindowTinyLfuPolicy(Config config) {
