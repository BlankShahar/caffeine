...
@Policy.PolicySpec(name = "non-binary.black-box.SegmentedLRU")
public final class BBNBSegmentedLruPolicy implements Policy {
  ...
  public BBNBSegmentedLruPolicy(Config config) {
  ...
  static class Prefix {
    ...
    double recency() {
      return 1.0 / (BBNBSegmentedLruPolicy.currentTime - lastRequestTime + 1);
    }
