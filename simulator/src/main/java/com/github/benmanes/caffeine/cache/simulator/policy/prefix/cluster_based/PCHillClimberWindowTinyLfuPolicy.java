...
@Policy.PolicySpec(name = "prefix.cluster-based.HillClimberWindowTinyLFU")
public class PCHillClimberWindowTinyLfuPolicy implements Policy {
    ...
    public PCHillClimberWindowTinyLfuPolicy(Config config) {
