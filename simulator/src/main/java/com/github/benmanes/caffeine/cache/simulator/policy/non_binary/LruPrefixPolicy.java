...
@Policy.PolicySpec(name = "non-binary.LruPrefix")
public final class LruPrefixPolicy implements Policy {
    ...
    public LruPrefixPolicy(Config config) {
    ...
    public void record(AccessEvent event) {
        ...
        if (existingPrefix != null) {
            ...
            Source source = new NormalSource(0.003, 0.00075, 10);
